...
/**
 * SearchBar Component
 * Provides search functionality and member filtering for updates
 *
 * @param {Object} props - Component props
 * @param {string} props.searchTerm - Current search term
 * @param {Function} props.onSearch - Callback for search term changes
 * @param {string} props.selectedMember - Currently selected team member filter
 * @param {Function} props.onMemberFilter - Callback for member filter changes
 * @param {Array} props.members - List of team members for filter dropdown
 */
const SearchBar = ({
  searchTerm,
  onSearch,
        ...
        <div className="flex-grow">
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
              <svg
                className="w-5 h-5 text-muted-enhanced"
                fill="currentColor"
                viewBox="0 0 20 20"
